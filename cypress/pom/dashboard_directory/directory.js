// Page Object Model untuk halaman Directory OrangeHRM
...
class Directory {
    ...
    assertEmployeeFound(name) {
        cy.contains('.oxd-text.oxd-text--p.orangehrm-directory-card-header.--break-words', name)
        .should('be.visible');
    ...
    // Intercept request API Directory
    interceptDirectory() {
        cy.intercept(
            'GET', 
